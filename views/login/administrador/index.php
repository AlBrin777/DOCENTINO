<?php echo require "views/navbar_log_a.php"; ?>
  <div class="container" style="margin-top:50px; margin-bottom:50px;">
    <form action="<?php echo constant("URL"); ?>login/acceso_administrador" method="POST" id="formSing" class="form-signin" enctype="multipart/form-data">
        <div class="panel">
        <div><i>ADMINISTRADOR</i></div>
            ...
            <div class="text-center" style="padding:5px;">
                  <a href="<?php echo constant("URL"); ?>login/recuperar_cuenta_admin">Olvido de Contraseña </a>
                  <a href="<?php echo constant("URL"); ?>registro/administrador">| Registrarse</a>
               </div>
         </div>
       </form>
</div>
