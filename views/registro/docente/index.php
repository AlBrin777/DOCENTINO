  ...
  <div class="container" style="margin-top:50px; margin-bottom:50px;">
    <form action="<?php echo constant("URL"); ?>registro/registrar_docente" method="POST" id="formSing" class="form-signin" enctype="multipart/form-data">
        <div class="panel">
        <div><i>DOCENTE</i></div>
            <div class="panel-body text-center">
              ...
              <div class="form-group form-animate-text" style="margin-top:20px !important;">
                <input type="text" id="user" class="form-text" name="user_name" required>
                <span class="bar"></span>
            ...
            <div class="text-center" style="padding:3px;">
              <a href="<?php echo constant("URL"); ?>login/docente">¿Ya tienes una cuenta?</a>
            </div>
         </div>
       </form>
</div>
