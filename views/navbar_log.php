...
<body style="background-image: URL('<?php echo constant("URL");?>publics/img/fondo-1e3.jpg');">
 <!-- start: Header -->
        ...
        <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><b><a href="<?php echo constant("URL");?>login/docente">Acceder</a></b></li>
                <li class="user-name"><b>|</b></li>
                <li class="user-name"><b><a href="<?php echo constant("URL");?>registro/docente">Registrarse</a></b></li>
              </ul>
            </div>
          </div>
        </nav>
